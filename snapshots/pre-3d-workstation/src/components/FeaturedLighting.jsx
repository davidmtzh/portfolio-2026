...
// Approximate SVG pixels travelled per second.
// Increase this number if you want the electricity to move faster.
const PULSE_SPEED = 1050
const ARRIVAL_SPEED_STEP = 1.33

// Prevent very short paths from feeling instantaneous.
  ...
  useEffect(() => {
    ...
    articles.forEach((article, index) => {
      ...
      const duration = Math.max(
        MIN_TRAVEL_TIME,
        length / (PULSE_SPEED * speedMultiplier)
      )
