...
export function Background() {
  return <section id="background" className="background section-shell"><SectionLabel number="05">Education & experience</SectionLabel><div className="section-heading"><h2>A foundation<br /><span>with many layers.</span></h2><p>Engineering gives me the tools.<br />Teaching keeps me asking better questions.</p></div><div className="background-grid"><div><h3 className="list-heading">Education <span>01—05</span></h3>{[
