...
export default function App() {
  ...
  return <MotionConfig reducedMotion={reduced ? 'always' : 'user'}>
    ...
    <main id="main"><ContinuousCircuit reduced={reduced} /><Hero reduced={reduced} /><Story reduced={reduced} /><ProjectExplorer reduced={reduced} /><FeaturedProjects reduced={reduced} /><Background /><Contact /><GameTerminal reduced={reduced} /></main>
