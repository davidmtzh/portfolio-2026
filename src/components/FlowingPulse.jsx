...
export function FlowingPulse({ d, legs, reduced = false, duration = 3.5, scope, color = '#a9edf4', onArrival, onLegStart, activation = 'visible', repeat = true, restartOnReentry = false, delay = 0, repeatDelay = 0.65, legGap = 0.3 }) {
  ...
  }, [routeKey, reduced, duration, scope, onArrival, onLegStart, activation, repeat, restartOnReentry, delay, repeatDelay, legGap])
